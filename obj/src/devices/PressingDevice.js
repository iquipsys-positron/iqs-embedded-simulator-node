...
class PressingDevice {
    ...
    simulateState() {
        ...
        if (pip_services3_commons_node_4.RandomBoolean.chance(1, 10))
            this._pressed = true;
        else if (pip_services3_commons_node_4.RandomBoolean.chance(1, 20))
...
exports.PressingDevice = PressingDevice;
//# sourceMappingURL=PressingDevice.js.map