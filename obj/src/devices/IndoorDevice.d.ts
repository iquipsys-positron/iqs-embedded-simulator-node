...
export declare class IndoorDevice implements IConfigurable, IReferenceable, IOpenable {
    private _orgId;
    private _udi;
    ...
    private _connector;
    private _intervalId;
    private _useBeaconsInterval;
    private _useBeaconsEndTime;
    private _usingBeacons;
    constructor();
