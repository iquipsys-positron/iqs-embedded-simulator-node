"use strict";
/**
 * Teltonika randomly moving device with stops and batch inserts
 */
...
class TeltonikaSimDevice {
    ...
    open(correlationId, callback) {
        ...
        this._intervalId = setInterval(() => { this.updateStatus(); }, (1000 * 60));
    ...
    simulateState() {
        ...
        if (hasCoordinates) {
            // Calculate next point. 10% chance to stay on same place
            if (pip_services3_commons_node_3.RandomFloat.nextFloat(0, 1) > 1) {
                this._logger.info(this._udi, "Adding value to coords");
                this._deltaLatitude = pip_services3_commons_node_3.RandomFloat.nextFloat(0, 1) > 0.5 ? 0.001 : -0.001;
                this._deltaLongitude = pip_services3_commons_node_3.RandomFloat.nextFloat(0, 1) > 0.5 ? 0.001 : -0.001;
...
exports.TeltonikaSimDevice = TeltonikaSimDevice;
//# sourceMappingURL=TeltonikaSimDevice.js.map