...
class FreezingDevice {
    constructor() {
        ...
        this._freezeEndTime = null;
        this._freezeInterval = 0; // min
    ...
    configure(config) {
        ...
        this._freezeInterval = config.getAsIntegerWithDefault('freeze_interval', this._freezeInterval);
    ...
    simulateState() {
        if (this._freezeEndTime == null) { // first run
            this._freezeEndTime = new Date();
            this._freezeEndTime.setMinutes(this._freezeEndTime.getMinutes() + this._freezeInterval);
            this._moveEndTime = new Date();
            this._moveEndTime.setMinutes(this._freezeEndTime.getMinutes() + this._moveInterval);
        }
        let currentDate = new Date();
        if (currentDate <= this._freezeEndTime) { // freeze
            this._freezed = true;
        }
        else if (currentDate > this._freezeEndTime) { // start moving
            if (currentDate <= this._moveEndTime) { // move
                ...
                this._freezeEndTime.setMinutes(this._moveEndTime.getMinutes() + this._freezeInterval);
                this._moveEndTime.setMinutes(this._freezeEndTime.getMinutes() + this._moveInterval);
            }
        }
...
exports.FreezingDevice = FreezingDevice;
//# sourceMappingURL=FreezingDevice.js.map