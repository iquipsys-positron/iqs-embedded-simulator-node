...
export declare class LoraSimulatorConnector implements ISimulatorConnector, IConfigurable, IReferenceable, IOpenable {
    ...
    private deviceUdiToEui;
    private deviceEuiToUdi;
