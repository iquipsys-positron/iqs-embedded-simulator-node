...
export class SimulatorDevice implements IConfigurable, IReferenceable, IOpenable {
    ...
    private simulateState() {
        ...
        if (RandomBoolean.chance(1, 50))
            this._pressed = true;
        else if (RandomBoolean.chance(1, 200))
