...
export class ImmobileDevice implements IConfigurable, IReferenceable, IOpenable {
    ...
    private _immobileEndTime: Date = null;
    private _immobileInterval: number = 0; // min
    private _moveEndTime: Date = null;
    private _moveInterval: number = 0; // min
    ...
    private simulateState() {
        ...
        if (currentDate <= this._immobileEndTime) { // immobile
            ...
            if (currentDate <= this._moveEndTime ) { // move
                ...
                this._deltaLatitude = RandomFloat.nextFloat(-0.001, 0.001);
                this._deltaLongitude = RandomFloat.nextFloat(-0.001, 0.001);
