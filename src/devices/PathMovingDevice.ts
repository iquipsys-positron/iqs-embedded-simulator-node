...
export class PathMovingDevice implements IConfigurable, IReferenceable, IOpenable {
    ...
    private _movingForward: boolean = true;
    ...
    public configure(config: ConfigParams): void {
        ...
        for(let i: number =0; i < strPath.length; i++) {
