...
export class TwoPointsDevice implements IConfigurable, IReferenceable, IOpenable {
    ...
    private _latitudeFirstPoint: number = 0;
    private _lngtitudeFirstPoint: number = 0;
    private _latitudeSecondPoint: number = 0;
    private _lngtitudeSecondPoint: number = 0;
    private _presenceInterval: number = 0; // min
    private _presenceEndTime: Date = null;
